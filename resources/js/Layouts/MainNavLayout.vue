    ...
    >
        ...
        >
            <Link href="/" class="pl-3 min-w-[55px]">
                <img src="/images/icons/Facebook_icon.png" alt="">
            </Link>
            <div class="
                flex 
                items-center 
        ...
        <div id="NavCenter" class="hidden lg:flex items-center ml-5 justify-center w-8/12 max-w-[600px]">
            <Link href="/" class="w-full">
                ...
                >
                    <Home v-if="$page.url === '/'" :size="27" fillColor="#1A73E3" />
        ...
        <div class="flex items-center justify-end w-2/12 mr-4">
            ...
            <div class="flex items-center justify-center relative">
                ...
                <div v-if="showMenu" class="absolute bg-white shadow-xl top-10 right-0 w-[330px] rounded-lg p1 border mt-1">
